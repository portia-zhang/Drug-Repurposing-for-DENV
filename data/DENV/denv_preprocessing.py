...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Prepare the compound-viral activity test file for DENV viral proteins')
    parser.add_argument('input1', help='Fasta file containing information about DENV viral proteins')
    parser.add_argument('input2', help='File containing standard_inchi_key, names and canonical smiles of compounds of interest obtained as result of get_all_compounds_DENV.py')
    parser.add_argument('output', help='Test compound-viral protein interactions file for DENV virus')
    ...
    interaction_df.to_csv("denv_Compound_Viral_interactions_for_Supervised_Learning_full_metadata.csv",index=False)
    ...
    #Combine train, test and denv dataset to have information about all compounds and viral proteins for downstream torchtext prediction files
