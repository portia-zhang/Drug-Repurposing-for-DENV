# A Consensus of In-silico Sequence-based Modeling Techniques for Compound-Viral Protein Activity Prediction for DENV
...
Here `<type>` can be either `Train` or `Test` or `denv`.
