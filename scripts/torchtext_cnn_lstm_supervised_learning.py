...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Run CNN-LSTM based end-to-end deep learning model for compound-viral acitivty prediction')
    ...
    parser.add_argument('output', help='Output of CNN-LSTM based end-to-end deep learning model')
    ...
    #Make predictions on DENV viral proteins
    ...
    # +
    #Remove comments in this cell in order to run in train mode
    ...
    if (torch.cuda.is_available()):
        ...
        model.load_state_dict(torch.load('../models/cnn_lstm_out/cnn_lstm_supervised_checkpoint.pt',map_location=torch.device('cpu')))
    ...
    for data in output_list:
        ...
        fout.write(temp_str+"\n")
    fout.close()
    print("Finished running CNN-LSTM based end-to-end deep learning model")
