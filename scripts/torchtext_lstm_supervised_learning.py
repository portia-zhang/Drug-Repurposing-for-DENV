...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Run LSTM based end-to-end deep learning model for compound-viral acitivty prediction')
    ...
    parser.add_argument('output', help='Output of LSTM based end-to-end deep learning model')
    ...
    #Predict activity score for DENV viral proteins
