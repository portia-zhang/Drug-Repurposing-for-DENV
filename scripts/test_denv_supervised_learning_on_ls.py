...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Create the test file for denv compound-viral protein interactions with embedding for compounds + embeddings for proteins')
    parser.add_argument('input1', help='The denv compound-viral interactions file for end-to-end deep learning')
    ...
    parser.add_argument('input4', help='File containging autoencoder for denv vrial proteins to be tested')
